...
export class LambdaEventCollectorExtensionStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const dotnetEventCollectorExtension = new LayerVersion(this, 'dotnet-event-collector-extension-layer', {
      code: Code.fromAsset(CodeAssets.getDotnetEventCollectorExtensionAssetDir()),
